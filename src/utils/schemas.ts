...
export const structureSchema = S.schema({
  ...
  exterior_door_installation_date: S.optional(S.string),
  ...
  exterior_wall_insulation_type_primary: S.optional(S.string),
  exterior_wall_insulation_type_secondary: S.optional(S.string),
  finished_base_area: S.optional(S.number),
  finished_basement_area: S.optional(S.number),
  finished_upper_story_area: S.optional(S.number),
  ...
  foundation_repair_date: S.optional(S.string),
  ...
  interior_wall_structure_material_primary: S.optional(S.string),
  interior_wall_structure_material_secondary: S.optional(S.string),
  interior_wall_surface_material_primary: S.optional(S.string),
  interior_wall_surface_material_secondary: S.optional(S.string),
  number_of_buildings: S.optional(S.number),
  ...
  siding_installation_date: S.optional(S.string),
  structural_damage_indicators: S.optional(S.string),
  subfloor_material: S.optional(S.string),
  unfinished_base_area: S.optional(S.number),
  unfinished_basement_area: S.optional(S.number),
  unfinished_upper_story_area: S.optional(S.number),
  window_frame_material: S.optional(S.string),
  window_glazing_type: S.optional(S.string),
  window_installation_date: S.optional(S.string),
